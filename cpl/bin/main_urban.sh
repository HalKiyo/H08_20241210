...
############################################################
NOFMOS=4                # number of mosaic (sub-grid cell)
#
ARAFRC1=../../map/out/irg_frcd/S05_____20000000${SUF}FX
ARAFRC2=../../map/out/irg_frcs/S05_____20000000${SUF}FX
ARAFRC3=../../map/out/rfd_frc_/S05_____20000000${SUF}FX
ARAFRC4=../../map/out/non_frc_/S05_____20000000${SUF}FX
#ARAFRC1=../../map/out/irg_frcd/uniform.0.0${SUF}FX # URBAN toy/full/full2 for Tokyo
#ARAFRC2=../../map/out/irg_frcs/sum-ds${SUF}FX      # URBAN toy/full/full2 for Tokyo
#
...
PLTDOY1=../../crp/out/plt_1st_/${PRJ__C_}${RUN__C_}${YEARMIN}0000${SUF}
PLTDOY2=../../crp/out/plt_2nd_/${PRJ__C_}${RUN__C_}${YEARMIN}0000${SUF}
HVSDOY1=../../crp/out/hvs_1st_/${PRJ__C_}${RUN__C_}${YEARMIN}0000${SUF}
HVSDOY2=../../crp/out/hvs_2nd_/${PRJ__C_}${RUN__C_}${YEARMIN}0000${SUF}
CRPTYP1=../../map/out/crp_typ1/M08_____20000000${SUF}
CRPTYP2=../../map/out/crp_typ2/M08_____20000000${SUF}
#PLTDOY1=../../crp/out/plt_ric_/${PRJ__C_}${RUN__C_}00000000${SUF}  #URBAN toy/full/full2 for Tokyo
#PLTDOY2=../../crp/out/plt_othg/uniform.0.0${SUF}                   #URBAN toy/full/full2 for Tokyo
#HVSDOY1=../../crp/out/hvs_ric_/${PRJ__C_}${RUN__C_}00000000${SUF}  #URBAN toy/full/full2 for Tokyo
#HVSDOY2=../../crp/out/hvs_othg/uniform.0.0${SUF}                   #URBAN toy/full/full2 for Tokyo
#CRPTYP1=../../map/out/crp_typ1/uniform.12.0${SUF}                  #URBAN toy/full/full2 for Tokyo
#CRPTYP2=../../map/out/crp_typ2/uniform.8.0${SUF}                   #URBAN toy/full/full2 for Tokyo
############################################################
...
#
#DEMIND=../../map/dat/dem_ind_/AQUASTAT20000000.toy${SUF}FX # Ind wat dem URBAN toy
#DEMDOM=../../map/dat/dem_dom_/AQUASTAT20000000.toy${SUF}FX # Dom wat dem URBAN toy
#
DEMIND=../../map/dat/dem_ind_/AQUASTAT20000000.full${SUF}FX # Ind wat dem URBAN full
DEMDOM=../../map/dat/dem_dom_/AQUASTAT20000000.full${SUF}FX # Dom wat dem URBAN full
#
...
#FRCGWDOM=../../map/dat/frc_gwd_/D12${SUF}              # gw fraction
#
#outdated FRCGWIND=../../URBAN/pre/frcgwi.full2${SUF}           # gw fraction URBAN for full2
#outdated FRCGWDOM=../../URBAN/pre/frcgwd.full2${SUF}           # gw fraction URBAN for full2
#FRCGWIND=../../map/dat/frc_gwi_/FUL2____${MAP}${SUF}           # gw fraction URBAN for full2
#FRCGWDOM=../../map/dat/frc_gwd_/FUL2____${MAP}${SUF}           # gw fraction URBAN for full2
############################################################
...
#
# reservoir settings for urban model
#
#      DAMID_=../../map/dat/dam_id__/GRanDtk520190000${SUF}FX
#      DAMPRP=../../map/dat/dam_prp_/GRanDtk520190000${SUF}FX
#      DAMCAP=../../map/dat/dam_cap_/GRanDtk520190000${SUF}FX
#      DAMSRF=NO
#   DAMMON1ST=../../riv/out/fld2dro_/${PRJLR__}${RUNLR__}00000000${SUF}
#      DAMALC=../../map/out/dam_alc_/${PRJLR__}${RUNLR__}${SUF}ID
#DAMRIVOUTFIX=../../riv/out/riv_out_/${PRJLR__}${RUNLR__}00000000${SUF}
#DAMDEMAGRFIX=../../lnd/out/DemAgr__/${PRJN_C_}${RUNN_C_}00000000${SUF}FX
#      MSRCAP=../../dam/dat/uniform.0.0${SUF}FX
#      MSRAFC=../../dam/dat/uniform.0.0${SUF}FX
############################################################
...
# disable aqueduct
#
#LCAN=../../dam/dat/uniform.0.0.bin${SUF} # must be 10 times larger than the binary.
#
...
############################################################
# Parameter for grondwater (Edit here if you wish)
############################################################
...
OPTDAMRLS=H06    # H06 for res. operation shown  in Hanasaki et al. 2006
...
############################################################
#CTYDRN=NO                               # 
#CTYDRN=../../map/dat/cty_drn_/TOY_____${SUF}  # URBAN-toy
 CTYDRN=../../map/dat/cty_drn_/FUL1____${SUF}  # URBAN-full
#CTYDRN=../../map/dat/cty_drn_/FUL2____${SUF}  # URBAN-full2
############################################################
...
############################################################
    ...
    RTFDOM=NO
#
    DEMAGR0=${DIRDEMAGR0}/${PRJ}${RUN}${SUF}MO
